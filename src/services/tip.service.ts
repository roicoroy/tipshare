...
export class TipService {
  ...
  //   let tipLog: TipsRecord = { cycleDate: cycleDate,
  //     archived: false };
  //
  //   //Go to database and get waiters
  //   return this.waiterService.get().subscribe(waiters => {
  //     //Create an empty log for each waiter for a non specific day
  //     //TODO - Sum up points from waiter
  //     let emptyLogs = [];
  //     _.forEach(waiters, w => {
  //       emptyLogs.push({ waiterId: w.waiterId, points: 0, hours: 0, tips: 0 });
  //     });
  //
